...
CONSTRAINT fk_comment_entry FOREIGN KEY (accession)
REFERENCES entries(accession),
...
accession varchar2(10),
db_type VARCHAR2(10),
db_ref VARCHAR2(20), CONSTRAINT pk_dbref PRIMARY KEY (accession, db_type, db_ref),
CONSTRAINT fk_dbref FOREIGN KEY (accession) REFERENCES entries (accession));
...
CREATE TABLE entries_2_keywords (
accession VARCHAR2(10),
kw_id VARCHAR2(20),
